...
@section('content')
    ...
    <button type="button" id="btnLlamarAjax" class="btn btn-primary">Llamar</button>
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <span data-bind="text: labelData"></span>
    
    <div>
        <ul data-bind="foreach: labeltest">
            <li><span data-bind="text: name"></span></li>
            <li><span data-bind="text: color"></span></li>
        </ul>
    </div>
@endsection
